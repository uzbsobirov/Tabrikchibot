...
async def reklama_new(call: types.CallbackQuery, state: FSMContext):
    await call.message.edit_text(text="Xoxlagan reklama turingizni tanlang", reply_markup=types_private)

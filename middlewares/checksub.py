...
class BigBrother(BaseMiddleware):
    async def on_pre_process_update(self, update: types.Update, data: dict):
        ...
        #
        # else:
        #     if user == int(ADMINS[0]):
        #         await update.callback_query.message.delete()
        #         await update.callback_query.message.answer(text="Xush kelibsiz!", reply_markup=admin_main)
        #         raise CancelHandler()
        #     else:
        #         await update.callback_query.message.delete()
        #         await update.callback_query.message.answer(text="Xush kelibsiz!", reply_markup=main)
        #         raise CancelHandler()
